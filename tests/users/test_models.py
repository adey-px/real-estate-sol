...
# Base_user is obtained from conftest
...
def test_super_user_is_not_superuser(user_factory):
    ...
    assert str(err.value) == "Superuser must be a superuser"
...
def test_create_user_with_no_email(user_factory):
    ...
    assert str(err.value) == "Base User: An email address is required"
...
def test_create_superuser_with_no_email(user_factory):
    ...
    assert str(err.value) == "Super User: An email address is required"
